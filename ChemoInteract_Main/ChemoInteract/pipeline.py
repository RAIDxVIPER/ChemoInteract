...
from chemointeract.data import DatasetLoader, dataset_resolver
from chemointeract.models import Model, model_resolver
from chemointeract.utils import resolve_device
from chemointeract.version import __version__
            ...
            json.dumps(
                {
                    ...
                    "chemointeract_version": __version__,
                },
                indent=2,
            )
        )
...
def pipeline(
    *,
    ...
    :param dataset:
        ...
        2. A subclass of :class:`chemointeract.DatasetLoader`
        3. An instance of a :class:`chemointeract.DatasetLoader`
    :param model:
        The model can be specified in one of three ways:

        1. The name of the model
        2. A subclass of :class:`chemointeract.Model`
        3. An instance of a :class:`chemointeract.Model`
    :param model_kwargs:
